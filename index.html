        ...
        <div class="row justify-content-center">
          <div class="col-12 col-lg-9 register-glass">
            <div class="row g-5 justify-content-center">
              ...
              <div class="col-12 col-lg-5 mt-3 mb-4">
                <input type="number" class=" form-control" placeholder="Mobile Number" id="m">
              </div>
              <div class="col-12 col-lg-5 mt-3 mb-4">
                <input type="date" class=" form-control" placeholder="Birthday" id="b">
              </div>
              <div class="col-12 col-lg-5 mt-3 mb-4">
              ...
              <div class="col-lg-10 col-12  mt-3 mb-2">
